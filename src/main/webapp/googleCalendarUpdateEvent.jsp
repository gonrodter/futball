...
<html>
	<head>
		...
		<title>Editar un evento</title>
	</head>
	<body class="neweventform">
		<p class="message">${message}</p>
		
			<form action="/GoogleCalendarUpdateEvent" method="post">
				<div class="form__group">
				  <input type="text" class="form__input" id="title" placeholder="Event's title" required	/>
